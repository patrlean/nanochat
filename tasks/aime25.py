"""
The AIME 2025 dataset from Math-AI.
...
class AIME25(Task):
    ...
    def __init__(self, **kwargs):
        ...
        self.ds = load_dataset("math-ai/aime25", split="test").shuffle(seed=42)
    ...
    def get_example(self, index):
        ...
        solution = row["answer"] # the text answer
        # create and return the Conversation object
        # example answer of aime25 \boxed{371}
    ...
    def evaluate(self, conversation, assistant_response):
        ...
        last_text_part = assistant_message['content'][-1]['text'] # this contains the final answer in AIME 25
        # Extract both the ground truth answer and the predicted answer
        ref_num = last_text_part
