...
python -m scripts.chat_eval --source=mid --max-new-tokens=128 --max-problems=10 -a "AIME24|AIME25" --save-details
# python -m scripts.chat_eval --source=sft --max-new-tokens=128 --max-problems=100 -a "Safety" --save-details
# SFT
